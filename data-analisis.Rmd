...
results_summary$template <- paste("query template",
...
p_lines_select <- ggplot(results_summary, aes(x=scale_factor, y=time, group=engine_mode,
...
png(file="plots/select_queries_times.png",
    res=500, width=6000, height=4000, pointsize=25)
p_lines_select
dev.off()
```
```{r}
